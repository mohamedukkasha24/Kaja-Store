...
@Component({
  selector: 'app-household-essentials',
  templateUrl: './household-essentials.page.html',
  styleUrls: ['./household-essentials.page.scss'],
  standalone: true,
...
export class HouseholdEssentialsPage implements OnInit {
