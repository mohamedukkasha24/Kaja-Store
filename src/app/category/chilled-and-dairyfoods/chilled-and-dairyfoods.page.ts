...
@Component({
  selector: 'app-chilled-and-dairyfoods',
  templateUrl: './chilled-and-dairyfoods.page.html',
  styleUrls: ['./chilled-and-dairyfoods.page.scss'],
  standalone: true,
...
export class ChilledAndDairyfoodsPage implements OnInit {
