...
@Component({
  selector: 'app-creams-and-lotions',
  templateUrl: './creams-and-lotions.page.html',
  styleUrls: ['./creams-and-lotions.page.scss'],
  standalone: true,
...
export class CreamsAndLotionsPage implements OnInit {
